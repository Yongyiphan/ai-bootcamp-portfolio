...
Temperature guidance (set in the ask_json() call in analyzer.py):
  ...
  Evaluation prompts (KEYWORD_MATCH, BULLET_QUALITY, JARGON, STRUCTURE, DEGREE_ALIGNMENT): 0.2–0.3
...
# Purpose: compare the JD title with the supplied degree program's suggested titles.
# Input to ask_json():
#   system=DEGREE_ALIGNMENT_PROMPT
#   user="DEGREE PROGRAM: {degree_program}\n\nJD PROFILE:\n{json}"
# Expected output schema:
# {
#   "student_degree": "string", "jd_title": "string",
#   "title_on_suggested_list": true, "matched_against": "string",
#   "fit_commentary": "string (40 words or fewer)",
#   "degree_alignment_score": 100
# }
DEGREE_ALIGNMENT_PROMPT = """
Instruction: Check whether the JD job title aligns with the student's selected degree program.
Context: Use only this degree-aligned job-title list:
RTIS (Real-Time Interactive Simulation): Game Engine Developer, Systems Engineer,
Site Reliability Engineer (SRE), DevOps Engineer, AI/ML Engineer, Data Analyst / Data Scientist,
Full Stack Developer, Cybersecurity Engineer, Simulation Engineer, Graphics Programmer,
Technical Product Manager, Technical Project Manager.
IMGD (Interactive Media & Game Development): Game Developer, Systems Engineer,
Full Stack Developer, Data Engineer, Infrastructure Engineer, DevOps Engineer,
Cybersecurity Engineer, AI/ML Engineer, Technical Designer, Technical Artist,
Gameplay Programmer, Tools Engineer, Technical Product Manager, Technical Project Manager.
UXGD (User Experience & Game Design): App Developer, UI/UX Designer, Product Designer,
Product Manager, Product Operations Manager, Project Manager, Marketing & Design Specialist,
Process Architect, Technical Designer, Technical Artist, UX Researcher, UX Engineer.
BFA (Digital Art and Animation): Technical Artist, UI/UX Designer, Creative Designer,
Unreal Engine Artist, 3D Graphic Artist, Production Assistant, Project Manager,
Project Operations.
A title is on the suggested list when it matches exactly or is a clear variant; for example,
"Junior Systems Engineer" matches "Systems Engineer".
Constraints: Never invent a match. If the title is not on the list, assign a score from 50 to 70
and explain the mismatch in no more than 40 words. Never rewrite or generate résumé content.
Output: Return this JSON shape:
{"student_degree":"string","jd_title":"string","title_on_suggested_list":true,"matched_against":"string","fit_commentary":"string","degree_alignment_score":100}
Output ONLY a valid JSON object matching the schema above. No prose. No markdown fences. No commentary. Never rewrite or generate résumé content.
"""
...
and the most important diagnostic gaps across keyword match, bullets, jargon, structure, and degree alignment.
